    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-3 d-flex justify-content-end">
                <a href="{{ route('categorys.create') }}" class="btn btn-sm btn-primary mr-3">Add New</a>
                <a href="{{ route('categorys.index') }}" class="btn btn-sm btn-primary mr-3">All Category</a>
            </div>
        </div>
    </div>
